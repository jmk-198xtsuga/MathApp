...
//
///**
// * Unit testing for the ComplexNumber classes
// *
...
//    static ComplexNumber<Double> onePolar, oneCartesian;
//    static ComplexNumber<Double> fortytwoPolar, fortytwoCartesian;
//    static ComplexNumber<Double> negativeiPolar, negativeiCartesian;
//    static ComplexNumber<Double> negativeThree;
//
//    @BeforeAll
...
//        ComplexNumber<Double> i, one, mix, zero;
//        @BeforeAll
...
//                    ComplexNumber.Log(new ComplexDoublePolar(3d,42d)));
//        }
//        @Test
//        public void exponentTest() {
//            assertEquals(new ComplexDoublePolar(Math.PI/2d, 1d),
//                    ComplexNumber.Exp(new ComplexDoublePolar(Math.PI/2d,Math.PI/2d)));
//        }
//        @Test
//        public void inverseTest() {
//            ComplexDoubleCartesian check = new ComplexDoubleCartesian(76d, -0.78d);
//            assertEquals(check, ComplexNumber.Log(ComplexNumber.Exp(check)));
//            ComplexNumber<Double> image = ComplexNumber.Exp(ComplexNumber.Log(check));
...
//                        ComplexNumber.root(new ComplexDoubleCartesian(-1d, 0d), 2),
...
//                        ComplexNumber.root(new ComplexDoubleCartesian(0d, -1d), 3),
...
//                        ComplexNumber.root(new ComplexDoubleCartesian(-16d, 0d), 4),
...
//            ComplexNumber<Double> negativeOne;
//            List<ComplexNumber<Double>> list;
//            @BeforeAll
//            public void generateRoots() {
//                ComplexNumber<Double> quarterPi = new ComplexDoublePolar(Math.PI / 4d, 1d);
//                negativeOne = new ComplexDoubleCartesian(-1d, 0d);
//                list = ComplexNumber.roots(negativeOne, 4);
//                for (ComplexNumber<Double> each : list) {
