...
//        ComplexNumber<Double> onePolar;
//        ComplexNumber<Double> fortytwoPolar;
//        ComplexNumber<Double> negativeiPolar;
//
//        @BeforeAll
...
//                assertTrue(onePolar instanceof ComplexNumber, "Constructor returns an instance of ComplexNumber");
//            }
//
//            @Test
...
//            ComplexNumber<Double> negativeiPolar = new ComplexDoublePolar(-(Math.PI / 2), 1d);
//            assertEquals(new Double(-Math.PI / 2), negativeiPolar.Argument());
//        }
//        @Test
...
//    @Test
//    void ModulusTest() {
//        ComplexNumber<Double> fortytwoPolar = new ComplexDoublePolar(0d, 42d);
//        assertEquals(new Double(42d), fortytwoPolar.modulus(),
...
//        ComplexNumber<Double> fortytwoPolar;
//        ComplexNumber<Double> negativeiPolar;
//        ComplexNumber<Double> zero;
//        ComplexNumber<Double> one;
//
//        @BeforeAll
//        public void sampleConstructions() {
//            fortytwoPolar = new ComplexDoublePolar(0d, 42d);
...
//        ComplexNumber<Double> fortytwoPolar;
//        ComplexNumber<Double> anotherFortyTwoPolar;
...
//            ComplexNumber<Double> fortytwoCartesian = new ComplexDoubleCartesian(42d, 0d);
